                                ...
                                <td>
                                    <div class="input-group quantity mt-4" style="width: 125px;">
                                        <div class="input-group-btn me-1">
                                            <button class="btn btn-sm btn-minus rounded bg-light border" wire:click="minusCart('{{ $cart->id }}')">
                                        ...
                                        <div class="input-group-btn ms-1">
                                            <button class="btn btn-sm btn-plus rounded bg-light border" wire:click="addCart('{{ $cart->id }}')">
                ...
                <div class="bg-light rounded">
                    <div class="p-4">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="">
                                <p class="mb-0">Flat rate: Ksh. {{'350.00'}}</p>
                            </div>
                        </div>
                    ...
                    <div class="py-4 mb-4 border-top  d-flex justify-content-between">
                        ...
                        <p class="mb-0 pe-4 fw-bold text-primary">Ksh. {{$sum+350}}</p>
                    </div>
                    @if($carts->count() > 0)

                    <div class="modal-footer">
                        <button class="btn border-secondary rounded-pill px-3 py-2 text-primary text-uppercase mb-4 ms-4" type="submit" wire:click="processToCheckout">Proceed Checkout</button>
                    </div>
                    @endif
                </div>
            </div>
